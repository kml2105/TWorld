...
import com.semonics.tworld.Model.CountryModel;
...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void apiCall() {
        try {
            new BaseAPIService(SignUpActivity.this, SERVICE_ADD_USER, RequestParams.addUser(etUserName.getText().toString().trim(), etPw.getText().toString().trim()), false, responseListener, METHOD_POST, true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        public void onSuccess(String res) {
            try {
                ...
                if (code == 200) {
                    ...
                    methodToast(SignUpActivity.this, msg);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
