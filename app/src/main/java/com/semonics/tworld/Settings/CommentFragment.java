...
public class CommentFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       RadioButton rbEveryone = view.findViewById(R.id.rbEveryone);
        RadioButton rbPplFollowYou = view.findViewById(R.id.rbPplFollowYou);
        RadioButton rbNoOne = view.findViewById(R.id.rbNoOne);
        sessionManager = TWorld.getInstance().getSession();
        if(sessionManager.getInt(PREF_COMMENT)==0){
            rbEveryone.setChecked(true);
        }else if(sessionManager.getInt(PREF_COMMENT)==2){
            rbPplFollowYou.setChecked(true);
        }else{
            rbNoOne.setChecked(true);
        }
