package com.semonics.tworld.SimpleClasses;
...
import static com.semonics.tworld.WebService.BaseAPIService.TAG_EXCEPTION;
...
public class Utils {
    ...
    public static Map<String, String> getHeaders(Context context) {
        ...
        try {
            ...
            String authKey = TWorld.getInstance().getSession().getString(SessionManager.PREF_TOKEN);
