...
public class Profile_F extends RootFragment implements View.OnClickListener {
    ...
    private MentionVideoFragment mentionVideoFragment;
    ...
    public View init() {
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 2 && mentionVideoFragment != null) {
                    mentionVideoFragment.apiCall();
                }
            }
    ...
    public void apiCall() {
        try {
            new BaseAPIService(context, SERVICE_GET_USER, null, true, responseListener, METHOD_GET, true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
